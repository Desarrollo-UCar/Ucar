    ...
    @endif
        ...
        @endif 
            ...
            <div class="box box-primary">
              ...
              <form action="{{ route('empleado.update',$emp->idempleado)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                  <div class="box-body">           
                      <div class="col-md-4 col-md-offset-5  file-loading">
                        <div id="preview" >
                          ...
                          @else
                          <img src="{{ asset('storage').'/'.$emp->foto }}" style="width: 200px;height:200px;border-radius: 50%;">
                          @endif
                    ...
                    <div class="row" style="margin-left: 0.1%;margin-right: 0.1%;">
                      <div class="form-group col-md-4">
                          <label>Curp</label>
                      <input type="text" class="form-control" autofocus placeholder="curp" name="curp" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$emp->curp}}" pattern="[A-Z]{4}[0-9]{6}[A-Z]{6}[0-9|A-Z][0-9]" required>
                      </div>
                    </div>                  
                    ...
                    {{-- FORMULARIO DE NOMBRES --}}
                      ...
                      <div class="form-group col-md-4">
                          <label>Nombres</label>
                          <input type="text" class="form-control" placeholder="nombres" name="nombres" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$emp->nombres}}"  required>
                      </div>
                        {{-- FOMULARIO DEL PRIMER APELLIDO --}}
                        
                        <div class="form-group col-md-4">
                            <label>Primer Apellido</label>
                            <input type="text" class="form-control" placeholder="primerApellido" name="primerApellido" onkeyup="javascript:this.value=this.value.toUpperCase();"
                            value="{{$emp->primerApellido}}" required>
                        </div>
                          ...
                          <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control" placeholder="segundoApellido" name="segundoApellido" onkeyup="javascript:this.value=this.value.toUpperCase();" 
                              value="{{$emp->segundoApellido}}" required>
                          </div>

                          <div class="form-group col-md-4">
                              <label>Fecha de Nacimiento</label>
                              <input type="date" class="form-control" placeholder="fechaNacimiento" name="fechaNacimiento" value="{{$emp->fechaNacimiento}}" required>
                          </div>

                          <div class="form-group col-md-4">
                              <label>nacionalidad</label>
                              <input type="text" class="form-control" placeholder="nacionalidad" name="nacionalidad" onkeyup="javascript:this.value=this.value.toUpperCase();" 
                              value="{{$emp->nacionalidad}}" required>
                          </div>
                          ...
                          <div class="form-group col-md-4">
                            <label>Pais</label>
                            <input type="text" class="form-control" placeholder="pais" name="pais" onkeyup="javascript:this.value=this.value.toUpperCase();"
                            value="{{$emp->pais}}" required>
                        </div>

                        <div class="form-group col-md-4">
                          <label>Estado</label>
                          <input type="text" class="form-control" placeholder="estado" name="estado" onkeyup="javascript:this.value=this.value.toUpperCase();"
                          value="{{$emp->estado}}" required>
                      </div>

                          <div class="form-group col-md-4">
                              <label>Ciudad</label>
                              <input type="text" class="form-control" placeholder="ciudad" name="ciudad" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$emp->ciudad}}" required>
                          </div>

                          <div class="form-group col-md-4">
                              <label>Colonia</label>
                              <input type="text" class="form-control" placeholder="colonia" name="colonia" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$emp->colonia}}" required>
                          </div>

                          <div class="form-group col-md-4">
                              <label>Calle</label>
                              <input type="text" class="form-control" placeholder="calle" name="calle" value="{{$emp->calle}}" required>
                          </div>

                          <div class="form-group col-md-4">
                              <label>Número</label>
                              <input type="number" class="form-control" placeholder="Número de casa" name="numero" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$emp->numero}}" required>
                          </div>

                          <div class="form-group col-md-4">
                            <label>Teléfono</label>
                            <input type="text" class="form-control" placeholder="Teléfono" name="telefono" data-inputmask='"mask": "(999) 999-9999"' data-mask value="{{$emp->telefono}}" required>
                        </div> 

                          <div class="form-group col-md-4">
                              <label>Correo</label>
                              <input type="email" class="form-control" placeholder="Correo Eléctronico" name="correo" value="{{$emp->correo}}" required>
                          </div>
                      ...
                      <div class="form-group col-md-4" style="display: none;" id="vencimiento">
                        ...
                        <input type="date" class="form-control" name="licenciaFechaExpiracion" placeholder="Fecha de expiración de licencia" id="licenciaFechaExpiracion" value="{{$emp->licenciaFechaExpiracion}}">
                    </div>
 ...
 <script src= "{{asset("assets/$theme/plugins/input-mask/jquery.inputmask.extensions.js")}}"></script>
  ...
  <script>
    ...
    if (texto=='CHOFER') {
      ...
      document.getElementById("numLicencia").value=null;
      }
  }
    </script>
