 ...
 <aside class="main-sidebar" style="position: fixed;> <!-- style="position: fixed;height: 100%;width: 245px;overflow-y: scroll;" -->
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-plus-circle"></i> <span> Servicio Extra </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="{{route('mantenimiento.index')}}"><i class="fa fa-circle-o"></i>Ver Todos</a></li>
            </ul>
          </li> 

          <li class="treeview">
              @if(auth::user()->hasRole('gerente'))
              <a href="#"><i class="fa fa-cogs"></i><span>Servicios Taller </span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            @endif
            <li class="treeview">
                <li><a href="{{ route('cliente.index') }}"><i class="fa fa-user-circle-o"></i><span>Clientes</span></a> </li>
